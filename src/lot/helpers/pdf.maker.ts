...
export class PdfMaker {
    ...
    make(bulletin: Bulletin){
          ...
          const  docDefinition = {
            ...
            watermark: { text: 'bulletin 2024', color: 'grey', opacity: 0.3, bold: true, italics: false },
          content: [
            {
              columns: [
                {
                ...
                stack: [
                  ...
                  {text:"SOCIALES DU SINE-SALOUM",fontSize: 8,bold: true}
                ]},
                {
                  with:'20%',
                  alignment:'right',
                ...
                table: {
                  ...
                  body: [
                    ...cal.retenues(bulletin.lignes['retenues']).map((a,i) => {
                        if(i === 0){
                            return [{text:`${a.rubrique.code} ${a.rubrique.libelle}`,style: 'header2',border:[true,true,true,false]},{text:a.base || '',style: 'nombre',border:[false,true,true,false]},{text:a.taux1 || '',style:'header2',border:[false,true,true,false]},{text:a.montant,style: 'nombre',border:[false,true,true,false]},{text:'',border:[true,false,true,false],fillColor:'white'},{text:a.taux2 || '',style: 'header2',border:[false,true,true,false]},{text:a.taux2 ? Math.round(a.taux2 * a.base / 100) : '',style:'nombre',border:[false,true,true,false]}]
                        }
                         return [{text:`${a.rubrique.code} ${a.rubrique.libelle}`,style: 'header2',border:[true,false,true,false]},{text:a.base || '',style: 'nombre',border:[false,false,true,false]},{text:a.taux1 || '',style:'header2',border:[false,false,true,false]},{text:a.montant,style: 'nombre',border:[false,false,true,false]},{text:'',border:[true,false,true,false],fillColor:'white'},{text:a.taux2 || '',style: 'header2',border:[false,false,true,false]},{text:a.taux2 ? Math.round(a.taux2 * a.base / 100) : '',style:'nombre',border:[false,false,true,false]}]
                    }),
                    [{text:'Total Retenues',colSpan:3,bold: true},'','',{text:cal.totalRetenue,style:'total'},{text:'',border:[true,false,true,false]},{text:cal.tppr || '',style:'total',colSpan:2},'']
                  ]
                }
            },
            {
                ...
                table: {
                  ...
                  body: [
                    ...
                    [{text:'Total Non Imposable',colSpan:3,bold: true,fillColor:'white'},'','',{text:cal.totalNomImposable,style:'total'},{text:'',border:[true,false,true,false],fillColor:'white'},{text:cal.tppni || '',style:'total',colSpan:2},'']
                  ]
                }
            },
            {
                ...
                table: {
                  ...
                  body: [
                    ...
                    [{text:'Totaux Annuels',style:'header2'}, {text: 'Brut',style:'header2'}, {text:'Charges Salariale',style:'header2'},{text:'Charges Patronales',style: 'header2'},{text:'Avantages',style: 'header2'},{text:'Net A Payer',style: 'header2'}],
        ...
        const options = {};
          ...
          pdfDoc.pipe(createWriteStream(`src/lot/bulletins/${employe._id}-${mois}-${annee}.pdf`));
          pdfDoc.end();
    }

    makeAll(bulletins: Bulletin[]){
